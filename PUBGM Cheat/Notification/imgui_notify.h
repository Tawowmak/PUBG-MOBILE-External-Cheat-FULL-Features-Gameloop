...
namespace ImGui
{
	...
	{
		static const ImWchar icons_ranges[] = { 0x01, 0xffff,0 };
		...
		GetIO().Fonts->AddFontFromMemoryCompressedTTF(font_awesome_data, font_awesome_size, 16.0f, &icons_config, icons_ranges);
	}
}
